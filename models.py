...
def get_clients_and_tasks_for_user(user_id: int):
    """Export helper.

    Returns one row per client-task for the given user.
    If a client has no tasks, still returns one row with task fields as None.
    """
